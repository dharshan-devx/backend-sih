...
urlpatterns = [
    ...
    path("beneficiary/form/", views.beneficiary_create_or_update, name="beneficiary_form"),
    path(
    "beneficiary/ml-input/<str:phone>/",
    views.beneficiary_ml_input_by_phone,
    name="beneficiary_ml_input_by_phone",
),
